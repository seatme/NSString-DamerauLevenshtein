...
- (NSUInteger)distanceFromString:(NSString *)comparisonString options:(JXLDStringDistanceOptions)options;
{
	...
	if (options & JXLDLiteralComparison) {
		...
		string1_mutable = (__bridge CFMutableStringRef)[self mutableCopy];
		string2_mutable = (__bridge CFMutableStringRef)[comparisonString mutableCopy];
		...
		string1 = (__bridge CFStringRef)string1_mutable;
		string2 = (__bridge CFStringRef)string2_mutable;
	}
...
- (float)semanticDistanceFromString:(NSString *)comparisonString weights:(JXLDWeights)weights;
{
	...
	CFMutableStringRef string2_mutable = (__bridge CFMutableStringRef)[comparisonString mutableCopy];
